"""Get Prices from Amber in a timeley manner"""
...
async def async_unload_entry(hass: HomeAssistant, entry: AmberConfigEntry) -> bool:
    LOGGER.debug("Called amber_prices async_unload_entry()")
